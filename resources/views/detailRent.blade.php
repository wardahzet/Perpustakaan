...
<html>
  ...
  <div class="relative bg-white">
    ...
    <div class="content bg-200 my-10 mx-10 rounded-lg py-5 ">
      <div class="container bg-[rgb(255,250,239)] flex px-10 ">
    ...
    <!-- <div
      ...
      <px-grid x="991fr minmax(0px, max-content) 374fr" y="128px minmax(0px, max-content) 982fr" absolute="true"><h4
          class="flex justify-center font-normal text-[18px] leading-normal font-Poppins text-black text-center tracking-[0px] w-full h-full">
          Penerbit
        </h4>
      </px-grid>
      <px-grid x="1161fr minmax(0px, max-content) 182fr" y="128px minmax(0px, max-content) 982fr" absolute="true"><h4
          class="flex justify-center font-normal text-[18px] leading-normal font-Poppins text-black text-center tracking-[0px] w-full h-full">
          Kategories
        </h4>
      </px-grid>
      <px-grid x="648fr minmax(0px, max-content) 753fr" y="128px minmax(0px, max-content) 982fr" absolute="true"><h4
          class="flex justify-center font-normal text-[18px] leading-normal font-Poppins text-black text-center tracking-[0px] w-full h-full">
          ISBN
        </h4>
      </px-grid>
      <img class="rounded-[15px] w-[180px] h-auto align-top object-contain object-[center_top] absolute top-[231px] left-[180px] min-w-[180px]"
      ...
      <px-grid x="400px 176fr 864fr" y="733px minmax(0px, max-content) 332fr" absolute="true">
      ...
      <px-grid x="978px 105fr 357fr" y="749px minmax(0px, 48fr) 340fr" absolute="true"><h5 class="font-normal text-base font-Poppins text-black tracking-[0px] w-full h-full">
          Bhuana Ilmu Populer<br/>
        </h5>
      </px-grid>
