...
<div class=" mx-auto max-w-7xl px-4 sm:px-6">
  ...
  <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0" id="profile">
    ...
    <a href="{{ route('login') }}" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-[#EA9901] -600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-[#BF7D01]">Login</a>
  </div>
</div>
    @endauth
</div>
