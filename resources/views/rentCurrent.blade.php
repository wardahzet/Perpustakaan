  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6">
    <div class="flex items-center justify-between border-b-2 border-gray-300 py-6 md:justify-start md:space-x-10">
      ...
      <div class="flex justify-start">
        <div class="mb-0 xl:w-96 mr-16 -mx-40">
          <input
            type="search"
      ...
      <nav class="hidden space-x-10 md:flex">
        ...
        <a href="#" class="text-base font-medium text-Black-500 hover:text-gray-900">Profile</a>
      </nav>
      <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
        <a href="#" class="inline-flex items-center rounded-md border border-[#EA9901] bg-white px-4 py-2 text-base font-medium text-[#EA9901] shadow-sm hover:bg-gray-300">Logout</a>
      </div>
    </div>
  </div>
</div>
